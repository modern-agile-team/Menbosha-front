    ...
    <div>
      ...
      <S.UserpageWrapper>
        ...
        <S.ElementSection>
          ...
          <S.ProfileLinkImg onClick={() => handleRouter(`/userpage/info`)}>
        ...
        <S.ElementSection>
          ...
          <S.TempLinkImg onClick={() => handleRouter(`/userpage/badge`)}>
        ...
        <S.ElementSection>
          ...
          <S.ReviewLinkImg onClick={() => handleRouter(`/userpage/review`)}>
            <S.ReviewLinkText>후기</S.ReviewLinkText>
          </S.ReviewLinkImg>
        </S.ElementSection>
        <S.ElementSection>
          <S.ChatLinkImg onClick={() => handleRouter(`/chat/[id]`)}>
