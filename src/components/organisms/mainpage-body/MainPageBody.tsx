          ...
          <S.MainContents3Right>
            ...
            <S.MainContents3InfoContainer>
              <S.InfoBox>
                ...
                <S.InfoTextBox>
                  글만 쓰고 기다리기엔 답답할 때, 바로 멘토와 1대1 채팅을 시작할
                  수 있는 시스템. 불필요한 과정을 제외해 서로의 이해 관계를 쉽게
                  보충할 수 있습니다.
                </S.InfoTextBox>
              </S.InfoBox>
              <S.InfoBox>
                ...
                <S.InfoTextBox>
                  ...
                  진행됩니다. 간단한 카테고리만 선택해도 좋고, 더욱 마음에
                  들었다면 짧은 글을 남겨주세요.
                </S.InfoTextBox>
              </S.InfoBox>
              <S.InfoBox>
                ...
                <S.InfoTextBox>
                  복잡한 리뷰도 신뢰도에 중요한 영향이 있지만, 이를 종합해
                  자신이 믿을만 한 사람인지 한눈에 볼 수 있도록 그래픽으로
                  표시하는 시스템을 도입했습니다.
                </S.InfoTextBox>
              </S.InfoBox>
              <S.InfoBox>
